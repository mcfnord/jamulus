...
ssh -i ~/.ssh/id_ed25519 "$USER@$HOST" '
  ...
  sudo apt-get install -y libqt5core5a libqt5network5 libqt5xml5 libjack-jackd2-0 libqt5widgets5 libqt5multimedia5
...
echo "==> Done. Edit --serverinfo and -w in the service file on the server, then:"
